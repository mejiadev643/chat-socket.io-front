                ...
                <div class="flex h-full border rounded shadow-lg border-grey">
                    ...
                    <div class="flex flex-col w-1/3">
                        ...
                        <div class="flex-1 overflow-auto bg-grey-lighter">
                            <div class="flex items-center px-3 cursor-pointer bg-grey-light">
                                <div>
                    ...
                    <div class="flex flex-col w-2/3 border">
                        ...
                        <div class="flex-1 overflow-auto" style="background-color: #DAD3CC">
                            <div class="px-3 py-2">
                                ...
                                <div class="flex justify-center mb-2">
                                    <div class="px-4 py-2 rounded" style="background-color: #DDECF2">
                                ...
                                <div class="flex mb-2">
                                    <div class="px-3 py-2 rounded" style="background-color: #F2F2F2">
                                ...
                                <div class="flex justify-end mb-2">
                                    <div class="px-3 py-2 rounded" style="background-color: #E2F7CB">
                                        <p class="mt-1 text-sm">
                                            Hi guys.
                                        </p>
                                        <p class="mt-1 text-xs text-right text-grey-dark">
                        ...
                        <!-- Input -->
                        <div class="flex items-center px-4 py-4 bg-grey-lighter">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                            ...
                            <div class="flex-1 mx-4">
                                <input class="w-full px-2 py-2 border rounded" type="text" />
                            </div>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
